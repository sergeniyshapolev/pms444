...
ssize_t calc_write(struct file *filp, const char *buffer, size_t length, loff_t *offp)
{
...
ssize_t calc_show_result(struct file *filp, char *buffer, size_t length, loff_t *offp) 
{
	char str[BUFF_SIZE];
...
static int __init proc_init(void)
{
	...
	proc_create("calc_result", 0666, NULL, &calc_result_fops);
